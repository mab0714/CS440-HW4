        ...
        static void Main(string[] args)
        {
            ...
            {            
                ...
                {                                        
                    ...
                    rP.MoveRightPaddle(b, currentStateTuple);
            ...
            Console.Clear();            
                ...
                for (int y = 0; y < boardY + 2; y++)
                {
                    ...
                    for (int x = 0; x < boardX + 2; x++)
                    {
                        ...
                        {
                            if (x == lPlayer.DiscretePaddleX + 1 && y == lPlayer.DiscretePaddleY+1)
                            {
                                Console.Write("|");
                            }
                        }
