...
namespace Pong
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //rP.Memory = ReadQ(@"I:\Backup\Masters\UIUC\2016\Fall\CS_440\Homework\4\CS440-HW4\Pong_TA_10\Pong\Q.txt");
            //rP.MemoryVisited = ReadN(@"I:\Backup\Masters\UIUC\2016\Fall\CS_440\Homework\4\CS440-HW4\Pong_TA_10\Pong\\N.txt");
            ...
            for (int numTrial = 0; numTrial < totalTrials; numTrial++)
            {
                ...
                Write(rP.Memory, @"I:\Backup\Masters\UIUC\2016\Fall\CS_440\Homework\4\CS440-HW4\Pong_TA_10\Pong\Q2.txt");
                Write(rP.MemoryVisited, @"I:\Backup\Masters\UIUC\2016\Fall\CS_440\Homework\4\CS440-HW4\Pong_TA_10\Pong\N2.txt");
