...
namespace Pong
{
    class Player
    {
        ...
        public Player(double paddleX, double paddleY, double learningConstant, double discountFactor, Tuple<int, int, int, int, int> state, int boardX, int boardY, int explorationLimit)
        {
            ...
            using (var sr = new StreamReader(@"I:\Backup\Masters\UIUC\2016\Fall\CS_440\Homework\4\CS440-HW4\Pong_TA_10\Pong\Q2.txt"))
            {
                string line = null;
                ...
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    Tuple<int, int, int, int, int, string> newTuple = Tuple.Create(Int32.Parse(tuple.Split(' ')[0].Trim(',')), Int32.Parse(tuple.Split(' ')[1].Trim(',')), Int32.Parse(tuple.Split(' ')[2].Trim(',')), Int32.Parse(tuple.Split(' ')[3].Trim(',')), Int32.Parse(tuple.Split(' ')[4].Trim(',')), tuple.Split(' ')[6].ToString());
            ...
            using (var sr = new StreamReader(@"I:\Backup\Masters\UIUC\2016\Fall\CS_440\Homework\4\CS440-HW4\Pong_TA_10\Pong\N2.txt"))
            {
                string line = null;
                ...
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    //newTuple = Tuple.Create(Int32.Parse(tuple.Split(' ')[0].Trim(',')), Int32.Parse(tuple.Split(' ')[1].Trim(',')), Int32.Parse(tuple.Split(' ')[2].Trim(',')), Int32.Parse(tuple.Split(' ')[3].Trim(',')), Int32.Parse(tuple.Split(' ')[4].Trim(',')), tuple.Split(' ')[6].ToString());
                    //this._N.Add(newTuple, value);
                    //newTuple = Tuple.Create(Int32.Parse(tuple.Split(' ')[0].Trim(',')), Int32.Parse(tuple.Split(' ')[1].Trim(',')), Int32.Parse(tuple.Split(' ')[2].Trim(',')), Int32.Parse(tuple.Split(' ')[3].Trim(',')), Int32.Parse(tuple.Split(' ')[4].Trim(',')), tuple.Split(' ')[5].ToString());
                    //this._N.Add(newTuple, value);
